...
# With this in mind, We've attempted to not expose internals to keep things as simple as possible.
# Nothing actually prevents you from modifying the object.
#
# See README.md for example usage, but basically
# 
#
